...
class Inscripciones extends Base
{
	...
	{
		$query = "SELECT id, usuario_id, dni, nombre, apellido, fecha_nacimiento, genero, email, telefono, domicilio, ciudad, provincia, pais, codigo_postal, contacto_emergencia_nombre, contacto_emergencia_apellido, contacto_emergencia_telefono, talle_remera, team_agrupacion, categoria_edad, codigo_descuento, tipo_mime, nombre_archivo, acepta_promocion, idItem, idPago  , importe , pagado, rEntregada FROM $this->table_name WHERE pagado = 1 AND usuario_id = :idx";
	...
	{
		$query = "SELECT id, usuario_id, dni, nombre, apellido, fecha_nacimiento, genero, email, telefono, domicilio, ciudad, provincia, pais, codigo_postal, contacto_emergencia_nombre, contacto_emergencia_apellido, contacto_emergencia_telefono, talle_remera, team_agrupacion, categoria_edad, codigo_descuento, tipo_mime, nombre_archivo, acepta_promocion, idItem, idPago , importe , pagado, rEntregada FROM $this->table_name WHERE idPago = :idPago";
